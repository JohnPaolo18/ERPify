...
import { fetchAlbumTracks, playTrack, addToLikedSongs } from "../helpers/spotifyAPI";
  ...
  return (
    <LinearGradient colors={["#040306", "#131624"]} style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Tracks in Album</Text>
      </View>
      {tracks.length > 0 ? (
        <FlatList
          data={tracks}
        ...
        <Text style={styles.placeholderText}>No tracks available in this album.</Text>
      )}
    </LinearGradient>
  );
};
